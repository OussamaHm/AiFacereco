...
<style>
  ...
  background: linear-gradient(to bottom, #0c0e29, #2b2d63, #24273e);
}
.main{
  width: 1080px;
 margin-right: 25%;
...
.conf {
  background:linear-gradient(to bottom, #2b2d63 5%, #000000 100%);
...
.conf:hover {
  background:linear-gradient(to bottom, #000000 5%, #2b2d63 100%);
...
<div id="question" style=" position: -webkit-sticky">
                ...
                <input class="conf" type="button" value="No" onclick="usertest(false);" />
                 ...
                 <h1 style = "color: white;font-family: 'Jost', sans-serif; align-self: center;"> Welcome Back <i style = "color: #8d9cfc;font-family: 'Jost', sans-serif; align-self: center;"><?php echo " $nameuser !"; ?></i></h1> <h1 style = "color: white; font-family: 'Jost', sans-serif; align-self: center;" >Complete your<br> Login using FaceID!</h1>
        </div>
  ...
  <p style= "color: darkgray"> <i> <br><br> Click on camera to open your webcam.  <br>
     <a style= "color: #9fabfc" href="http://localhost/Courier-Hacks/Login/index.php">Click here if you are not registred yet !</a>
 </i>  </p> 
    </div>
